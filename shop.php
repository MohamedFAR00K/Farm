...
#pic_3{
	background-image: url("img/frt.jpg");
	 background-repeat: no-repeat;
...
<div class="col-sm-4 col-sm-6 col-lg-6">   <!-- Product--1 starts -->
		...
		<div class="product">
			...
			<p class="buttons" >
						...
						<span><h3 id="pic1_txt"><b>PESTICIDES</b></h3></span>
					</p>
			</div>
		</div>			
...
<div class="col-sm-4 col-sm-6 col-lg-6">   <!-- Product--1 starts -->
		...
		<div class="product" >
			...
			<p class="buttons">
						...
						<span><h3 id="pic1_txt"><b>Fertilizer</b></h3></span>
					</p>
			</div>
		</div>			
...
<div class="col-sm-4 col-sm-6 col-lg-3">   <!-- Product--1 starts -->
		...
		<div class="product">
			...
			<p class="buttons">
						...
						<span><h3 id="pic1_txt"><b>Seeds</b></h3></span>
					</p>
			</div>
		</div>			
