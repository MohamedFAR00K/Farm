		...
		<div class="row">
			<div class="col-md-3 text-center">
				<div class="icon">
					...
					<h3>Pesticides</h3>
					<p> In court, the lawyer representing the butter company simply held up the container of butter and said to the judge, "My client did not lie. The container is indeed 'light in weight'. </p>
